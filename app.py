...
st.title("Recommandation de produits par IA")
...
st.write(
    "Ce MVP recommande des produits à partir des notes laissées par des utilisateurs similaires. "
    "Il repose sur une logique de collaborative filtering avec cosine similarity."
)
st.write(
    "Limites actuelles : le dataset ne contient pas les noms produits, donc le MVP affiche des IDs produits. "
    "Une version future intégrerait des métadonnées produits pour construire un système hybride plus riche."
)
